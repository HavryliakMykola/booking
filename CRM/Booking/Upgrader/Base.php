 ...
 */
class CRM_Booking_Upgrader_Base {

  /**
   * @var CRM_Booking_Upgrader_Base
   */
   ...
   *
   * ```
   * CRM_Booking_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Booking_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
